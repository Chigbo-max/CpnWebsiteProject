...
const Privacy = () => (
  <div className="max-w-3xl mx-auto py-12 px-4 text-gray-900">
    ...
    <p className="mb-4">We do not sell or rent your personal information. We may share your information with trusted third-party service providers who assist us in operating our website and services, or as required by law. We require these third parties to protect your information and use it only for the purposes we specify.</p>
    <h2 className="text-xl font-semibold mt-6 mb-2">4. Cookies and Tracking Technologies</h2>
    <p className="mb-4">We use cookies and similar tracking technologies to enhance your experience, analyze usage, and improve our services. You can control the use of cookies through your browser settings.</p>
    ...
    <p>If you have any questions about this Privacy Policy, please contact us at cprofessionalsnetwork@gmail.com.</p>
  </div>
);
