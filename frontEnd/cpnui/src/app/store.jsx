...
import { enrollmentApi } from '../features/admin/enrollmentApi';
import { userManagementApi } from '../features/admin/userManagementApi';
...
const store = configureStore({
    ...
    middleware: (getDefaultMiddleware) =>
      getDefaultMiddleware().concat(blogApi.middleware, eventApi.middleware, subscriberApi.middleware, contactApi.middleware, authApi.middleware, newsletterApi.middleware, adminManagementApi.middleware, profileApi.middleware, enrollmentApi.middleware, userManagementApi.middleware),
})
